...
const cart = (state = initialState, action) => {
    ...
    switch (action.type) {
        case 'ADD_PIZZA_CART': {
            ...
            // const arrOfPizzas = [].concat.apply([], Object.values(newItems));
            // const arrOfPizzas = [].concat.apply([], items)
            // const totalPriceOfArr = Object.keys(newItems).reduce((sum, key) => newItems[key].totalPrice + sum, 0)
